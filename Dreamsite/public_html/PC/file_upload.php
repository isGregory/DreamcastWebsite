...
?>
    ...
    <p>For the dreamcast to recognize a file to be downloaded it needs the
    ...
    <p>Dreamcast webbrowsers look for a special input type called "VMFILE"
        that allow the browser to search for and upload files to the server.
        <br>Example in HTML:
        <pre>&lt;input type='VMFILE' name='upfile' id='upfile'&gt;</pre>
    </p>

    <p>Once the browser uploads a file through a "POST" form there will be
    information for a VMI file and an encoded save that need to be converted
    to binary data.
    <br>The first line of the submitted content specifies the VMI file. This
        is followed by a blank line and then a long block of encoded data that
        is in 77 character long lines.
    </p>

    <p>Example of the start of a post message of a Sonic Adventure 2 save file:
        <pre>
...
AAAAAAAAAYAAAAAAAJR9O...
        ...
        <table cellpadding="3" cellspacing="1" border="0" style="max-width:640px;" bgcolor="#6E6E6E">
            ...
            <?php
                ...
                echo "
                    <tr bgcolor=" . ac($col) . ">
                        <td>filename</td>
                        <td>The name of the file in the VMU.</td>
                    </tr>
                    <tr bgcolor=" . ac($col) . ">
                        <td>fs</td>
                    ...
                    <tr bgcolor=" . ac($col) . ">
                        <td>tm</td>
                        <td>Date and time the file was saved to the VMU.
    ...
    <h3>Data Section</h3>
    <p>The save data is communicated through Base64 but is also jumbled
        requring a table to convert values before a Base64 Decode is used.
    </p>

    <p>To convert the data to a VMS file one needs to use a conversion table
    ...
    <p>The table used for conversion is:
        <table cellpadding="3" cellspacing="1" border="0" style="max-width:640px;" bgcolor="#6E6E6E">
            <tr bgcolor="#CCCCCC">
                <th colspan="2">Characters</th><th colspan="2">Hex</th>
            </tr>
<tr bgcolor="#CCCCCC">
                <th>From</th><th>To</th><th>From</th><th>To</th>
            </tr>
            <?php
                convTable('=', '=', 0x3D, 0x3D);
