...
<p>
	...
	directory, which should contain 1 for VMU game files, and 0 for data files.
</p>
...
<p>
	The palette is 32 bytes, consisting of 16 colors. Each color is a
	16-bit integer (little endian). The color fields are in the order
	of Blue, Green, Red and Alpha. Each field is 4-bits and thus a
	value from 0-15.
</p>
<p>
	The four fields for each 16-bit integer are set up as such:
	<?php
		fourColorPalette();
	?>
	Alpha of 15 is fully opaque, alpha of 0 is fully transparent.
</p>
...
<p>
	...
	at offset <code>0x40</code> accordingly). The bitmaps are stored directly
	after each other, starting at offset <code>0x80</code>.
</p>
<p>
...
<p>
	The header can optionally contain a 72 x 56 pixel image shown as a graphic
	eyecatch for the file in the DC boot ROM file manager. The graphic data
	for the eyecatch is stored immediately after the last icon bitmap.
</p>
