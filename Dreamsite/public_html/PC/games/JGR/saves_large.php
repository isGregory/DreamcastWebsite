...
<table cellpadding="3" cellspacing="1" border"0">
	<tr>
		...
		<td>
			<label>
				<h2 align="center">Large Graffiti File</h2>
				Here is the format of the Jet Grind Radio
				large custom graffiti file.
				<br><br>
...
<p>
	...
	<?php
		memoryTable( "LARGE.gif" );
			...
			memoryEntry( '0x2BB', '4,096', 'Binary Pixels',
				"Binary image alpha transparency map for graffiti.<br>"
				. "(256 width x 128 height / 8 bits per byte)" );
			memoryEntry( '0x12BB', 4, 'Unknown', "Unknown" );
			memoryEntry( '0x12BF', 'Variable', 'Jpeg Data',
...
<p>
	The Image is 256 x 128. The transparency map stores pixels as
	...
	or converting to some other format.
</p>
<br><br>
<?php
