<?php
	...
	$pageTitle = "JGR - Xtra-Large Graffiti";
...
<table cellpadding="3" cellspacing="1" border"0">
	<tr>
		...
		<td>
			<label>
				<h2 align="center">Xtra-Large Graffiti File</h2>
				Here is the format of the Jet Grind Radio
				xtra-large custom graffiti file.
				<br><br>
...
<p>
	...
	<?php
		memoryTable( "XLARGE.gif" );
			...
			memoryEntry( '0x2BB', '8,192', 'Binary Pixels',
				"Binary image alpha transparency map for graffiti.<br>"
				. "(512 width x 128 height / 8 bits per byte)" );
			memoryEntry( '0x22BB', 4, 'Unknown', "Unknown" );
			memoryEntry( '0x22BF', 'Variable', 'Jpeg Data',
...
<p>
	The Image is 512 x 128. The transparency map stores pixels as
