...
<p><h3 align="left"><u><a id="save">Game Saves</a></u></h3>
    <p align="left">There are three different save files for this game.
...
<p><h3 align="left"><u><a id="dlc">Downloadable Content</a></u></h3>
    ...
    changing the language options to Japanese.</p>
    <table align="center" cellpadding="3" cellspacing="1" border="0" width="90%" bgcolor="#6E6E6E">
        <tr bgcolor="#CCCCCC">
    ...
    <br><br>
    <p align="left">Version 2 quests were encrypted and locked to players so no
    downloads can be offered.</p>
    <table align="center" cellpadding="3" cellspacing="1" border="0" width="90%" bgcolor="#6E6E6E">
        <tr bgcolor="#CCCCCC">
...
<p><h3 align="left"><u><a id="shot">Screen Shots</a></u></h3>
    <p align="left">Phantasy Star Online allows users to take screen
        ...
        <table align="center" cellpadding="3" cellspacing="1" border="0" style="min-width:400px;max-width:640px;" bgcolor="#6E6E6E">
            ...
            <tr bgcolor="#CEEBF5">
                ...
                <td>Hold X and press Start</td>
            </tr>
            <tr bgcolor="#FFFFFF">
                <td>Entire Screen</td>
                <td>Hold A and press Start</td>
            </tr>
        </table>
        <br>
...
<p><h3 align="left"><u><a id="serv">Servers</a></u></h3>
    ...
    that there is an active subscription.</p>
