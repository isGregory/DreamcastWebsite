...
<p>The following is the contents of the body:
...
<p>The Image is 256x192. Pixels are stored as 16-bit colors
...
<p>Each Pixel is a 16-bit integer (little endian). The color fields
are in the order of Blue, Green, and Red. Red and Blue are both
5 bits, where Green is 6 bits.</p>
<p>The three fields for each 16-bit integer are set up as such:
    <table cellpadding="3" cellspacing="1" border="0" bgcolor="#6E6E6E">
        <tr align="center">
