...
?>
          ...
          <p><a id="head"><b>LCD file header</b></a> (16 Bytes)
            <table cellpadding="3" cellspacing="1" border="0" style="max-width:640px;" bgcolor="#6E6E6E">
                <tr bgcolor="#CCCCCC">
          ...
          <p>Each frame's info is 4 bytes. Thus the size of this section is 4 bytes x Frame Count. Frame info starts at <code>0x10</code>. The file lists out the info for all frames before it lists out all the frame data.</p>
          <p><a id="info"><b>Frame Info</b></a> (4 Bytes x Frame Count)
            <table cellpadding="3" cellspacing="1" border="0" style="max-width:640px;" bgcolor="#6E6E6E">
              <tr bgcolor="#CCCCCC">
          ...
          <hr>
          <p>Each frame's visual data makes up a 48x32 pixel image. Each pixel is 1 byte, and thus each frame is 1,536 bytes. Therefore the size of this section is 1,536 bytes x Frame Count. The file lists out the info for all frames before it lists out all the frame data.</p>
          <p><a id="data"><b>Frame Data</b></a> (1536[48x32] Bytes x Frame Count bytes)
            <table cellpadding="3" cellspacing="1" border="0" style="max-width:640px;" bgcolor="#6E6E6E">
              <tr bgcolor="#CCCCCC">
                <th>Size (bytes)</th><th>Description</th><th>Value</th>
              </tr>
          ...
          <p><a id="copyright"><b>Copyright</b></a> (40 bytes)
            <table cellpadding="3" cellspacing="1" border="0" style="max-width:640px;" bgcolor="#6E6E6E">
              <tr bgcolor="#CCCCCC">
                <th>Size (bytes)</th><th>Description</th><th>Value</th>
              </tr>
        ...
        <p>
          <br>The majority of this information is thanks to <a href="http://www.booyaka.com">booyaka.com</a></p>
          <?php
              $from = "file_lcd.php";
